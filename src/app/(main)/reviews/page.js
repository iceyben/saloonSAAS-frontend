      ...
      <section style={{ padding: "80px 24px", background: "var(--cream)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px" }} className="contact-grid">
          <div>
            ...
            {reviews.length === 0 ? (
              <p style={{ fontSize: "14px", color: "var(--dark-mid)", fontWeight: 300 }}>No reviews yet. Be the first!</p>
            ) : (
          ...
          <div>
            ...
            {submitted ? (
              <div style={{ background: "var(--rose-blush)", border: "1px solid var(--rose-light)", borderRadius: "4px", padding: "40px", textAlign: "center" }}>
                ...
                <h3 style={{ fontFamily: "var(--font-serif)", fontSize: "24px", marginBottom: "8px" }}>Thank You!</h3>
                <p style={{ fontSize: "14px", color: "var(--dark-mid)", fontWeight: 300 }}>Your review is awaiting approval.</p>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", gap: "8px" }}>
                    {Array.from({ length: 5 }).map((_, i) => (
                      <button key={i} type="button" onClick={() => setRating(i + 1)} onMouseEnter={() => setHover(i + 1)} onMouseLeave={() => setHover(0)} style={{ background: "none", border: "none", cursor: "pointer", padding: 0 }}>
