...
export default function GalleryPage() {
  ...
  return (
    <div style={{ paddingTop: "64px" }}>
      ...
      <section style={{ padding: "60px 24px", background: "var(--cream)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          {filtered.length === 0 ? (
            ...
            <div style={{ columns: "3", gap: "16px" }} className="gallery-photo-grid">
      ...
      <style>{`
        @media (max-width: 768px) { .gallery-photo-grid { columns: 2 !important; } }
        @media (max-width: 480px) { .gallery-photo-grid { columns: 1 !important; } }
      `}</style>
    </div>
  );
}
